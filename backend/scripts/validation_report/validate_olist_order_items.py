...
SAMPLE_FILE = str(BACKEND_ROOT / "data/processed/olist_order_items_dataset.csv")
EXPECTED_COLUMNS = [
    "order_id",
    "order_item_id",
    "product_id",
...
OUTPUT_REPORT = str(BACKEND_ROOT / "output/validation_report/olist_order_items_intake_report.json")
