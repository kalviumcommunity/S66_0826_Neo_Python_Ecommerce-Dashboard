...
SAMPLE_FILE = str(BACKEND_ROOT / "data/processed/olist_order_reviews_dataset.csv")
EXPECTED_COLUMNS = [
    "review_id",
    "order_id",
    "review_score",
...
OUTPUT_REPORT = str(BACKEND_ROOT / "output/validation_report/olist_order_reviews_intake_report.json")
