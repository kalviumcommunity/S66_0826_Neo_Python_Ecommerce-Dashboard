...
SAMPLE_FILE = str(BACKEND_ROOT / "data/processed/olist_customers_dataset.csv")
EXPECTED_COLUMNS = [
    "customer_id",
    "customer_unique_id",
...
OUTPUT_REPORT = str(BACKEND_ROOT / "output/validation_report/olist_customers_intake_report.json")
