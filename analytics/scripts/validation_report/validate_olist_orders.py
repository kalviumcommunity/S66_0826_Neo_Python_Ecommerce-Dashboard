...
SAMPLE_FILE = str(BACKEND_ROOT / "data/processed/olist_orders_dataset.csv")
EXPECTED_COLUMNS = [
    "order_id",
    "customer_id",
    "order_status",
...
OUTPUT_REPORT = str(BACKEND_ROOT / "output/validation_report/olist_orders_intake_report.json")
